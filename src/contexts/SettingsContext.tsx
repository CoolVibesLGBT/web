...
export const SettingsContext = ({
  ...
  React.useEffect(() => {
    ...
    const savedViewMode = localStorage.getItem('viewMode') as ViewMode | 'dome' | null;
    if (savedViewMode === 'dome') {
      localStorage.setItem('viewMode', 'grid');
      setViewModeState('grid');
      return;
    }

    if (savedViewMode && ['grid', 'list', 'card', 'map', 'bubble'].includes(savedViewMode)) {
