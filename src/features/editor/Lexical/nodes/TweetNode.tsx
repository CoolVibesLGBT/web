...
const Skeleton = () => (
  <div className="relative mx-auto min-h-[220px] w-full max-w-full overflow-hidden rounded-xl bg-gray-200 shadow-lg">
    {/* shimmer effect */}
...
function TweetComponent({
  ...
  const createTweet = useCallback(async () => {
    try {
      ...
      await window.twttr.widgets.createTweet(tweetID, containerRef.current, { dnt: true });
