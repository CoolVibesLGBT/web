      ...
      >
          ...
          <div className="relative h-[75vh] sm:h-[80vh] min-h-[600px] sm:min-h-[650px]">
            ...
            {nextProfile && (
              ...
              >
                <div 
                  className={`h-full rounded-[28px] sm:rounded-[32px] overflow-hidden relative ${
                    theme === 'dark' 
                ...
                <div className="absolute inset-0 w-full h-full z-0">
                  ...
                  >
                    ...
                    {currentProfile.images.length > 1 && (
                      <div className="absolute top-4 sm:top-6 left-4 sm:left-6 right-20 sm:right-28 flex gap-1.5 sm:gap-2">
                        {currentProfile.images.map((_, index) => (
                          <motion.div
                            key={index}
                            className={`h-[2.5px] sm:h-[3px] flex-1 rounded-full transition-all duration-500 ${
                    ...
                    <div className="absolute top-4 sm:top-6 right-4 sm:right-6 flex flex-row gap-2">
                      ...
                      {/* Match Percentage */}
                      <motion.div 
                        className={`backdrop-blur-xl rounded-full px-3 sm:px-4 py-1.5 sm:py-2 border ${
                          theme === 'dark'
                    ...
                    <X className={`w-5 h-5 ${theme === 'dark' ? 'text-white' : 'text-black'}`} />
                        ...
                        <div className="overflow-y-auto" style={{ maxHeight: 'calc(85vh - 100px)' }}>
                          <div className="p-4 sm:p-6">
                            {/* Tabs Navigation */}
                            <div className={`flex gap-1.5 sm:gap-2 mb-4 sm:mb-6 pb-3 sm:pb-4 border-b overflow-x-auto scrollbar-hide ${
                              ...
                              {[
                                ...
                                <motion.button
                                  ...
                                  className={`px-3 sm:px-5 py-1.5 sm:py-2.5 rounded-full text-xs sm:text-sm font-semibold whitespace-nowrap transition-all ${
                                    activeTab === tab.id
                                      ? theme === 'dark'
                                        ? 'bg-white text-black'
                                        : 'bg-black text-white'
                            ...
                            <AnimatePresence mode="wait">
                              ...
                              >
                                ...
                                >
                                  <motion.button 
                                    className={`w-full flex items-center justify-center gap-2 sm:gap-3 py-3.5 sm:py-4 rounded-xl sm:rounded-2xl font-semibold text-sm sm:text-base transition-all ${
                                      theme === 'dark'
        ...
        >
          {/* Pass Button */}
          <motion.button
            className={`w-14 h-14 sm:w-16 sm:h-16 rounded-full flex items-center justify-center border-2 transition-all shadow-lg ${
              theme === 'dark'
        ...
        >
          ...
          <div className={`flex gap-2 px-4 mb-4 overflow-x-auto scrollbar-hide ${
            ...
            {[
              { id: 'matches' as const, label: 'Eşleşmelerim', icon: Sparkles, count: matchedProfiles.length },
              { id: 'liked' as const, label: 'Beğendiklerim', icon: Heart, count: likedProfiles.length },
              { id: 'passed' as const, label: 'Beğenmediklerim', icon: Ghost, count: passedProfiles.length }
            ].map((tab) => (
              <motion.button
                key={tab.id}
                    ...
                    {matchedProfiles.length === 0 ? (
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {matchedProfiles.map((profile) => (
                          <motion.div
                            key={profile.id}
                            className={`relative rounded-2xl overflow-hidden p-4 border-2 ${
                              theme === 'dark'
